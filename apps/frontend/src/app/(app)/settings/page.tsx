        ...
        <div className='grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]'>
          ...
          <div className='rounded-[14px] border border-destructive/60 bg-card p-4'>
            ...
            <input
              ...
              className='mt-3 h-9 w-full rounded-4xl border border-input bg-input-bg px-3 text-sm text-foreground opacity-80 outline-none disabled:cursor-not-allowed disabled:opacity-80'
              disabled
              readOnly
