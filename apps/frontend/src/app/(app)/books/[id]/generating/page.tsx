  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center py-16 text-center">
      <div className="paper-card w-full p-8">
        <p className="mb-3 text-xs uppercase tracking-[0.35em] text-muted-foreground">Generating</p>
        <h1 className="section-heading !text-3xl">{book?.title ?? 'Your book is being prepared'}</h1>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link href="/books/new" className="rounded-xl bg-primary px-5 py-2 text-sm font-medium text-primary-foreground hover:opacity-90">
            Create Another Book
          </Link>
        </div>
      </div>
