...
export default function BooksDataTable({ books }: BooksDataTableProps) {
  return (
    <div className="overflow-x-auto" data-testid="books-list-mode">
      <table className="w-full min-w-[680px] border-collapse text-sm">
        <caption className="sr-only">Books in list view</caption>
        <thead>
          <tr className="border-b border-border/80 text-left text-muted-foreground">
            ...
            <th scope="col" className="px-4 py-3 font-medium">Child</th>
