...
export default function DashboardFilters({
  ...
  return (
    <div className='mb-5 flex flex-wrap items-center gap-2 rounded-2xl border border-border bg-ab-surface p-2'>
      ...
      >
        <SelectTrigger aria-label='Filter by status' className='h-[42px] w-auto min-w-[100px]'>
      ...
      >
        <SelectTrigger aria-label='Filter by style' className='h-[42px] w-auto min-w-[100px]'>
      ...
      >
        <SelectTrigger aria-label='Filter by type' className='h-[42px] w-auto min-w-[100px]'>
      ...
      <Select
        value={profile || '__all'}
        onValueChange={(value) => onProfileChange(value === '__all' ? '' : value)}
      >
        <SelectTrigger aria-label='Filter by profile' className='h-[42px] w-auto min-w-[100px]'>
      ...
      <Select value={sort} onValueChange={(value) => onSortChange(value as 'updated' | 'title')}>
        <SelectTrigger aria-label='Sort books' className='h-[42px] w-auto min-w-[100px]'>
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
