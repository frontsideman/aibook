export const subscriptionContent = {
  ...
  detail: '40 generated books per month • final PDF downloads included • renews July 1, 2026',
} as const;
...
export const dangerZoneContent = {
  title: 'Danger zone',
  body: 'Account deletion removes profiles, generated drafts, review history, and billing access. Final downloaded PDFs remain on your device only.',
